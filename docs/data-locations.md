...
```json
{
  ...
  "projectId": "golems",
  "originalPath": "/Users/etanheyman/Gits/golems",
  "sessions": [
    {
      "uuid": "abc123...",
...
- Old chunks reference `~/.claude/projects/-Users-etanheyman-Desktop-Gits-{repo}/`
- New chunks reference `~/.claude/projects/-Users-etanheyman-Gits-{repo}/`
